        ...
        <div className='bg-white shadow-md rounded px-8 py-6 max-w-md'>
            ...
            <form onSubmit={onSubmitHandler}>
                ...
                <div className='mb-3 min-w-72'>
                    ...
                    <input onChange={(e)=>setPassword(e.target.value)} value={password} className='rounded w-full px-3 py-2 border border-gray-300 outline-none' type="password" placeholder='Enter you password' required/>
                </div>
